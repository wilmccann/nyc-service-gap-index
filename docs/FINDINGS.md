...
*Profiled locally from the two CSVs on Saturday, September 19, 2026, during the hackathon. The numbers below are what the sanity checks at the end of [`build_notebook.sql`](../resources/notebooks/build_notebook.sql) reproduce.*
